        ...
        <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
            <div class="w-full py-9 bg-gray-50 rounded-2xl border border-gray-300 gap-3 grid border-dashed mb-5">
                <div class="grid gap-1">
                    ...
                    <h2 class="text-center text-gray-400 text-xs leading-4">Excel</h2>
                </div>
                ...
                <div class="flex items-center justify-center min-h-screen">
                    ...
                    <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full p-4 mb-4"
                        ...
                        <div class="flex items-center">
                            <h3 class="text-lg font-medium">¿Estás seguro que deseas eliminar a la empresa
                                {{ companyDeleted.name }}?
                            </h3>
                        </div>
                    ...
                    <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full"
                        ...
                        <form @submit.prevent="updateCompany(editedCompany.id, editedCompany)" class="p-4 md:p-5">
                            <div v-show="nextCompanyUpdateModal" class="grid gap-2 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2">
                                    <label for="floorNumber" class="block mb-2 text-sm font-medium text-gray-900">Número
                                        de
                            ...
                            <div v-show="!nextCompanyUpdateModal" class="grid gap-2 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-1">
                                    ...
                                    <select id="sampleSector"
                                        ...
                                        <option v-for="sampleSector in sampleSectors" :key="sampleSector.id"
                                            :value="sampleSector.id">
                                            {{ sampleSector.description }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col-span-1">
                                    <label for="sampleSize" class="block mb-2 text-sm font-medium text-gray-900">Tamaño
                                        de la
                                        muestra:</label>
                                    <select id="SampleSize"
                                        ...
                                        <option v-for="sampleSize in sampleSizes" :key="sampleSize.id"
                                            :value="sampleSize.id">
    ...
    methods: {
        uploadFile() {
            if (this.selectedFile) {
                ...
                GlobalService.createDataFile(`/company/upload-companies`, formData).then((response) => {
                    if (response.status == 200) {
                        this.toast.success("Compañias cargadas exitosamente");
                    }
                }).catch((e) => {
